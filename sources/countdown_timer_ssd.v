...
module countdown_timer_ssd #(
    ...
    reg [3:0] digit0;                // ones
    reg [3:0] digit1;                // tens
    reg [3:0] digit2;                // hundreds/blank
    reg [3:0] digit3;                // thousands/blank
    reg [3:0] LED_BCD;
    ...
    localparam integer SEC_COUNT_MAX = 100_000_000 - 1; // 100 MHz -> 1 sec
    ...
    localparam integer REFRESH_COUNT_MAX = 250_000 - 1; // 100 MHz / 250000 = 400 Hz
    ...
    always @(posedge clk or posedge reset) begin
        ...
        else if (enable && tick_1Hz && !expired) begin
